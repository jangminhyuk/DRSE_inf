...
LQR control experiment. The system evolves as:
    xₜ₊₁ = A xₜ + B uₜ + wₜ,   yₜ = C xₜ + vₜ,
with control input computed as u[t] = -K_lqr x_est[t]. The robust update
is performed at every time step via an optimization routine.
"""
