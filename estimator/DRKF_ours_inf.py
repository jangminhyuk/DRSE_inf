...
class DRKF_ours_inf:
    ...
    def DR_kalman_filter(self, v_mean_hat, x, y, mu_w=None, u=None):
        ...
        """
        # With no control input or B matrix, x is taken as the predicted state.
        x_pred = x
        # Predicted measurement based on x_pred.
        y_pred = self.C @ x_pred + v_mean_hat
        # Innovation:
        innovation = y - y_pred
        # Use the worst-case prior and measurement noise covariance.
